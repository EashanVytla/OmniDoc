...
urlpatterns = [
    path('main/<uuid:patient_id>/', main_view, name='main'),  # URL is handled in the app-level urls.py
    path('doctor/', doctor_patient_list_view, name='doctor_patient_list'),
    path('start-recording/<uuid:patient_id>/', start_recording, name='start_recording'),
